...
class Reservation(BaseModel):
    ...
    price: float | None = Field(default=None, description="价格，单位：元/月")
    house_description: str | None = Field(default=None, description="房源详细信息")
    city: str | None = Field(default=None, description="房子所在城市")
    area: str | None = Field(default=None, description="房子所在区县")
